  ...
  return (
    <>
      <article className="about-page">
        ...
        <p>
          My professional career has spanned various roles and industries, all centered around machine learning and data science. I began as a Deep Learning Researcher at a startup in Boston, focusing on reinforcement learning and computer vision. I then moved to Capital One as a Senior Data Scientist, where I worked on developing recommendation systems. My journey continued at Walmart, where I served as a Senior Machine Learning Engineer, delving into the realm of generative AI. Following that, I worked at JPMorgan Chase as a Senior Machine Learning Engineer, specializing in large language models (LLMs) and retrieval-augmented generation (RAG). I then joined Gryps as a Machine Learning Engineer, where I designed advanced RAG pipelines with query refinement, contextualized text chunking, and hybrid search systems. Currently, I am an Applied Scientist at Amazon, working on machine learning and Gen AI initiatives for the Ads Measurement Science organization.
        </p>
        <p>
